...
const AuthStack = createStackNavigator(
  {
    ...
    ManutencaoIluminacao: { screen: ManutencaoIluminacao, navigationOptions: {} },
    ScanQRCodeReader: { screen: ScanQRCodeReader, navigationOptions: {} },
    ManutencaoItem: { screen: ManutencaoItem, navigationOptions: {} },
    FotosItem: { screen: FotosItemScreen, navigationOptions: {} },
    ...
    RDOLiberarDocumentoEquipe: { screen: RDOLiberarDocumentoEquipe, navigationOptions: {} },
    RDOLiberarDocumentoRegistro: { screen: RDOLiberarDocumentoRegistro, navigationOptions: {} },
    MenuRDO: { screen: MenuRDO, navigationOptions: {} },
    ...
    AtividadesPendentes: { screen: AtividadesPendentes, navigationOptions: {} },
    TodosMateriaisItem: { screen: TodosMateriaisItem, navigationOptions: {} },
  },
  {
